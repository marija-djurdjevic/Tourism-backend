...
public class TouristEquipmentCommandTests : BaseToursIntegrationTest
{
    ...
    public void Creates()
    {
        ...
        // Assert - Database
        var storedEntity = dbContext.TouristEquipment.FirstOrDefault(i => i.Name == newEntity.Name);
    ...
    public void Updates()
    {
        ...
        // Assert - Database
        var storedEntity = dbContext.TouristEquipment.FirstOrDefault(i => i.Name == "Tečnost");
        storedEntity.ShouldNotBeNull();
        storedEntity.Description.ShouldBe(updatedEntity.Description);
        var oldEntity = dbContext.TouristEquipment.FirstOrDefault(i => i.Name == "Voda");
    ...
    public void Deletes()
    {
        ...
        // Assert - Database
        var storedCourse = dbContext.TouristEquipment.FirstOrDefault(i => i.Id == -3);
