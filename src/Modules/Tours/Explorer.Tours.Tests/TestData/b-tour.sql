INSERT INTO tours."Tour"(
    ...
    "PublishedAt", "ArchivedAt", "AverageScore", "Discriminator", "TouristNumber", "StartTime", "Duration", "Progress")
VALUES 
    (-1, 1, 'Leotar vertical', 'Vertical race to the top of the mountain', 0, '{{#hiking, #adventure}}', 1500, 0, '{{"Type": 0, "Time": 60, "Distance": 10.0}}',
    '2024-10-15 14:15:00', '2024-10-15 14:15:00', 4.5, 'Tour', NULL, NULL, NULL, NULL);
...
VALUES 
    ...
    '2024-10-15 14:15:00', '2024-10-15 14:15:00', 4.0, 'Tour', NULL, NULL, NULL, NULL);
...
VALUES 
    ...
    '2024-10-15 14:15:00', '2024-10-15 14:15:00', 5.0, 'Tour', NULL, NULL, NULL, NULL);