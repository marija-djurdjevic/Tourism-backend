...
VALUES (2, 'Centar', 'Centar Novog Sada, Spomenik Svetozara Miletica', 'neki putic', -2, '{{"Latitude": 19.833549, "Longitude": 19.833549}}');
INSERT INTO tours."KeyPoints"(
	"Id", "Name", "Description", "ImagePath", "TourId", "Coordinates")
VALUES (3, 'Tvrdjava', 'Radi se o Petrovaradinskoj tvrdjavi', 'neki putic', -2, '{{"Latitude": 45.24667, "Longitude": 19.87944}}');
